...
export function SistemasMultimidia() {
    ...
    const body = <>
        <Container fluid >
            <Row className="mt-5">
                ...
                <Col className="d-flex flex-wrap justiy-content-flex-start flex-direction-row" >
                        {
                            rest.map(function (cadeira) {
                                if (cadeira[1] == "Sistemas") {
                                    return (
    ...
    return (
        ...
        <>
            ...
            <Sidebar
                sidebarTitle='Sistemas Multimídia'
                content={body}
            />
